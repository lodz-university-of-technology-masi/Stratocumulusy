...
/**
 * Czy działa? Nie wiem jeszcze jak to odpalic xd. Ale...
 * Jest to sposób na stworzenie wszystkich wymaganych dla nas tables wraz z kluczami.
 * Można to zrobic tak, ale można i przez aws console dodając to samo ręcznie
 */
...
public class CreateTables {
    ...
    static String testTableName = "Test";
